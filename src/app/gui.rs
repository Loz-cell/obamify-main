...
impl App for ObamifyApp {
    ...
    fn update(&mut self, ctx: &egui::Context, frame: &mut Frame) {
                            ...
                            ui.horizontal_wrapped(|ui| {
                                ...
                                egui::ComboBox::from_label("")
                                    ...
                                    .show_ui(ui, |ui| {
                                        ...
                                        {
                                            ui.horizontal(|ui| {
                                                let remove_enabled = self.gui.presets.len() > 1;
                                ...
                                let button_response = if !self.gui.has_obamified_once {
                                    ...
                                    let button = egui::Button::new("Transform a new image")
                                        .stroke(egui::Stroke::new(1.0, glow_color));
                                    ui.add(button)
                                } else {
                                    ui.button("Transform a new image")
                                };
        ...
        if self.gui.configuring_generation.is_some() {
            Window::new("Portrait transformation")
                ...
                .show(ctx, |ui| {
                    ...
                    ui.allocate_ui_with_layout(
                        ...
                        |ui| {
                            ...
                            //     egui::RichText::new("Portrait transformation")
                            //         .heading()
                            //         .strong(),
                            // ));
                            // ui.separator();
